...
enum SemanticErrorCode {
    ...
    CREATING__CANT_CAST_TO_ARRAY_ELEMENT_TYPE,
    ...
    EXPR__CANT_CAST_TO_ARRAY_ELEMENT_TYPE_IN_ARRAY_SET_METHOD,
    ...
    EXPR_BIN_ARITHM__TYPE_OF_LEFT_OPERAND_IS_INVALID,
    EXPR_BIN_ARITHM__TYPE_OF_RIGHT_OPERAND_IS_INVALID,
};
